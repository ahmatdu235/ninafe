...
import { ArrowLeft, MapPin, Building2, Globe, Users, Briefcase, Moon, Sun, Menu, LogIn, ExternalLink } from "lucide-react";
...
export default function CompanyProfile() {
  ...
  const company = {
    ...
    website: "www.tchad-numerique.com",
    size: "50-100 employés",
    industry: "Technologie & Services",
    description: "Tchad Numérique est une agence leader dans la transformation digitale au Tchad. Fondée en 2018, notre mission est d'accompagner les entreprises locales et l'administration dans leur modernisation.\n\nNous valorisons l'innovation, la formation continue et l'esprit d'équipe. Nos bureaux sont situés au cœur de N'Djamena et offrent un cadre de travail moderne.",
    activeJobs: [
        ...
        <Card className="mb-8 border-t-4 border-t-brand-blue dark:bg-slate-900 dark:border-slate-800">
            <CardContent className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                    <Avatar className="h-24 w-24 border-2 border-slate-100 text-2xl">
            ...
            <div className="space-y-6">
                <Card className="dark:bg-slate-900 dark:border-slate-800">
                    ...
                    <CardContent className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                        <div>
                            <span className="font-semibold block text-slate-900 dark:text-slate-200">Email RH :</span>
                            recrutement@tchad-numerique.com
                        </div>
                        <div>
                            <span className="font-semibold block text-slate-900 dark:text-slate-200">Téléphone :</span>
                            +235 66 00 00 00
                        </div>
