          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input className="dark:bg-slate-950 dark:border-slate-700" placeholder="Ex: Tchad Numérique" value={companyName} onChange={e => setCompanyName(e.target.value)}/>
                </div>
                <div className="space-y-2">
                    <Label className="dark:text-slate-300">Présentation</Label>
                    <Textarea className="min-h-[80px] dark:bg-slate-950 dark:border-slate-700" placeholder="Décrivez votre activité..." value={companyDesc} onChange={e => setCompanyDesc(e.target.value)}/>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input className="dark:bg-slate-950 dark:border-slate-700" placeholder="Ex: Cherche Plombier expérimenté" value={title} onChange={e => setTitle(e.target.value)}/>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                        <Label className="dark:text-slate-300">Catégorie *</Label>
                        <Select onValueChange={setCategory}>
                            <SelectTrigger className="dark:bg-slate-950 dark:border-slate-700 dark:text-slate-300"><SelectValue placeholder="Sélectionner" /></SelectTrigger>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input className="dark:bg-slate-950 dark:border-slate-700" placeholder="Ex: N'Djamena" value={location} onChange={e => setLocation(e.target.value)}/>
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Select onValueChange={setContractType} defaultValue="CDI">
                        <SelectTrigger className="dark:bg-slate-950 dark:border-slate-700 dark:text-slate-300"><SelectValue placeholder="Type de contrat" /></SelectTrigger>
                        <SelectContent className="dark:bg-slate-950 dark:border-slate-700">
                ...
                <div className="space-y-2">
                    ...
                    <Textarea className="min-h-[150px] dark:bg-slate-950 dark:border-slate-700" placeholder="Détails..." value={jobDesc} onChange={e => setJobDesc(e.target.value)}/>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input className="dark:bg-slate-950 dark:border-slate-700" placeholder="Ex: Permis B, Java, Maçonnerie" value={tagsInput} onChange={e => setTagsInput(e.target.value)}/>
            ...
            <div className="space-y-2">
                ...
                <Input className="dark:bg-slate-950 dark:border-slate-700" placeholder="Ex: 150 000 FCFA" value={salary} onChange={e => setSalary(e.target.value)}/>
            </div>
